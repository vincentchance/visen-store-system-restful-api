...
import { createTestUser, removeAllTestUser1, removeAllTestUser, getTestUser, createTestAdmin, removeAllTestProduct } from './test-utils.js';
...
describe('POST /api/admin/product', function () {
	...
	it('should can create product', async () => {
		...
		console.log(result.body.data.prices);
